    ...
    <div id="editModal" style="display:none;">
        ...
        <form data-bind="submit: updatePlay">
            ...
            <div data-bind="foreach: [1, 2]">
                <label data-bind="text: $data + '枚目:'"></label>
                <select data-bind="value: selectedPlay().cards()[$data - 1].card_rank">
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
                    <option value="5">5</option>
                ...
                <select data-bind="value: selectedPlay().cards()[$data - 1].suit">
                    <option value="spade">♠</option>
                    <option value="heart">♥</option>
                    <option value="diamond">♦</option>
                    <option value="club">♣</option>
            ...
            <h3>ボード選択</h3>
            <div data-bind="foreach: ['flop1', 'flop2', 'flop3', 'turn', 'river']">
                <label data-bind="text: $data + ':'"></label>
                <select data-bind="value: selectedPlay().cards()[$index() + 2].card_rank">
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4"></option>
                    <option value="5">5</option>
                ...
                <select data-bind="value: selectedPlay().cards()[$index() + 2].suit">
                    <option value="spade">♠</option>
                    <option value="heart">♥</option>
                    <option value="diamond">♦</option>
                    <option value="club">♣</option>
